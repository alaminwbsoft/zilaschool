...
const Subornojoyonti = () => {
  return (
    <>
      <div className="bg-gray-100 p-3 shadow-sm rounded-sm w-full max-w-7xl mx-auto px-2 sm:px-2 lg:px-4 mt-2 mb-2 border ">
        {/* Header Section */}
        <div className="flex  items-center mb-4">
          ...
          <div>
            ...
            <p className="text-md font-bold text-gray-800 mt-4 hover:text-blue-500 cursor-pointer">
