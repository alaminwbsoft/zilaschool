...
const Downloads = () => {
  return (
    <>
      <div className="bg-gray-100 p-3 shadow-sm rounded-sm w-full max-w-7xl mx-auto px-2 sm:px-2 lg:px-4 mb-2 border">
        {/* Header Section */}
        <div className="flex items-center mb-4">
          ...
          />
          <h2 className="text-xl font-bold text-gray-800">ডাউনলোডস</h2>
        </div>
